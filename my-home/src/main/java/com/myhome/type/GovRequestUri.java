...
public enum GovRequestUri {
    ...
    BUILDING_SALE_OFFICETEL("openapi.molit.go.kr", "8081", "OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcOffiTrade", ResponseFormat.XML),// 오피스텔 매매 실거래자료
