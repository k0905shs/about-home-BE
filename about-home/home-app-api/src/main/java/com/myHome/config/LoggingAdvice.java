...
import com.myHome.config.core.Trace;
...
public class LoggingAdvice {
    ...
    @Around("execution(* com.myHome..*Service.*(..)) || execution(* com.myHome..*Repository*.*(..))" +
            " || execution(* com.myHome..*Controller.*(..)) || execution(* com.myHome..*GovApi.*(..))")
